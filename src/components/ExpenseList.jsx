  ...
  return (
    <div className='w-full'>
      <div className='flex justify-between items-center mb-4'>
        ...
        <select value={categoryFilter} onChange={(e) => setCategoryFilter(e.target.value)} className='px-3 py-1 rounded-md bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-expense-light focus:border-transparent'>
         {
...

      {
       ...
       <div className='bg-white rounded-lg shadow-sm p-8 text-center text-gray-500'>
         ...
         {
          categoryFilter !== "all" && (
           <p>Try changing the filter to see more expenses.</p>
          )}
       </div> 
       )  : (
